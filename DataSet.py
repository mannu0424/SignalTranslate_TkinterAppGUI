...
#                     'Como Estas', 'Mi', 'Estoy Bien', 'Lo Siento',
#                     'Gracias', 'Adios', 'Nombre es','Fondo Vacio'])
actions = np.array(['Nombre es'])
...
with mp_holistic.Holistic(static_image_mode=False, min_detection_confidence=0.5,
    ...
    while cap.isOpened():
        ...
        cv2.putText(image, 'Bienvenido', (240, 60), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 255, 0), 1,
                    cv2.LINE_AA)
        cv2.putText(image, 'Presione ESC para empezar', (120, 100), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 255, 0), 1,
                    cv2.LINE_AA)
